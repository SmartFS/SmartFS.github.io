<template>
  <div @touchstart="onTouchStart"
    ...
    >
      <iframe src="/html/Chinese_dragon.html" frameborder="0"
    ...
    <el-container class="home_container">
      ...
      <el-main class="home_main">
        <el-drawer
            ...
            class="custom-drawer"
            :with-header="false">
          <el-link style="margin-top:10px; width: 100px;height: 100px" href="https://github.com/smartfs"
                   target="_blank"
                   :underline="false">
...
<!--          </el-link>-->
      ...
      <el-footer class="home_footer">
        Copyright © 2024 smart-fs 保留所有权利
      </el-footer>
    </el-container>
  </div>
</template>
